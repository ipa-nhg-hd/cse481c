...
def main():
    ...
    list_pub = rospy.Publisher('pose_names', PoseNames, latch=True, queue_size=1)
    ...
    user_action_sub = rospy.Subscriber('user_actions', UserAction, server.handle_user_action)
